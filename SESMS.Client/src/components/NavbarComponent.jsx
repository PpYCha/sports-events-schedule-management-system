...
function NavListMenu() {
  ...
  return (
    <React.Fragment>
      <Menu allowHover open={isMenuOpen} handler={setIsMenuOpen}>
        <MenuHandler>
          <Typography as="a" href="#" variant="small" className="font-normal">
            <MenuItem className="text-blue-gray-900 hidden items-center gap-2 lg:flex lg:rounded-full">
      ...
      <MenuItem className="text-blue-gray-900 flex items-center gap-2 lg:hidden">
        <Square3Stack3DIcon className="h-[18px] w-[18px]" /> Pages{" "}
      </MenuItem>
...
const NavbarComponent = () => {
  ...
  return (
    <Navbar className="mx-auto w-full p-2 ">
      <div className="text-blue-gray-900 relative mx-auto flex items-center">
        <Typography
          as="a"
          href="#"
